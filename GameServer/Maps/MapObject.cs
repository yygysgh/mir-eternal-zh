        ...
        public void 对象移动时处理(MapObject 对象)
        {
            if (!(this is ItemObject))
            {
                ...
                if (PetObject != null)
                {
                    ...
                    {
                        PetObject.HateObject.RemoveHate(对象);
                    }
                }
                else
                {
                    ...
                    if (MonsterObject != null)
                    {
                        ...
                        {
                            MonsterObject.HateObject.RemoveHate(对象);
                        }
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (GuardInstance != null)
                            {
                                ...
                                {
                                    GuardInstance.HateObject.RemoveHate(对象);
                                }
                            }
                        }
                    }
            ...
            if (!(对象 is ItemObject))
            {
                ...
                if (PetObject2 != null)
                {
                    ...
                    {
                        PetObject2.HateObject.RemoveHate(this);
                        return;
                    }
                }
                else
                {
                    ...
                    if (MonsterObject2 != null)
                    {
                        ...
                        {
                            MonsterObject2.HateObject.RemoveHate(this);
                            return;
                        }
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (GuardInstance2 != null)
                            {
                                ...
                                {
                                    GuardInstance2.HateObject.RemoveHate(this);
                                }
                            }
                        }
                    }
            ...
            else if (this.Neighbors.Add(对象))
            {
                ...
                else if (this is PetObject PetObject2)
                {
                    if (!this.Died)
                    {
                        ...
                        {
                            PetObject2.HateObject.RemoveHate(对象);
                            return;
                        }
                    }
                }
                else if (this is MonsterObject MonsterObject2)
                {
                    if (!this.Died)
                    {
                        ...
                        {
                            MonsterObject2.HateObject.RemoveHate(对象);
                        }
